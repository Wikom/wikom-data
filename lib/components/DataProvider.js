...
var mapStateToProps = function mapStateToProps(state, _ref) {
    ...
    return {
        ...
        children: _react2.default.Children.map(children, function (Child) {
            ...
            return _react2.default.cloneElement(Child, _extends((_extends2 = {}, _defineProperty(_extends2, isLoadingProp, !state.queries[name] || state.queries[name].isPending === true), _defineProperty(_extends2, dataProp, state.data && state.data[name] || null), _defineProperty(_extends2, 'pagination', state.data && state.data.pagination && state.data.pagination[name] || null), _extends2), rest));
        })
    };
};
