...
var mapChildren = function mapChildren(Child, state, dataProp, isLoadingProp, name, dataMap, rest) {
    var _extends2;
    ...
    if (typeof dataMap === 'function' && (typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object' && data instanceof Array) {
...
var mapStateToProps = function mapStateToProps(state, _ref) {
    var children = _ref.children,
        ...
        rest = _objectWithoutProperties(_ref, ['children', 'name', 'url', 'force', 'dataProp', 'isLoadingProp', 'refresh', 'dataMap']);
    ...
    return {
        ...
        children: _react2.default.Children.map(children, function (Child) {
            return mapChildren(Child, state, dataProp, isLoadingProp, name, dataMap, rest);
        })
    };
};
