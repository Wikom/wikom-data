...
var mergeData = function mergeData(data) {
    var prependData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    var appendData = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
    return Array.isArray(data) && Array.isArray(prependData) && Array.isArray(prependData) ? prependData.concat(data, appendData) : data;
};
...
var mapChildren = function mapChildren(Child, state, dataProp, isLoadingProp, name, dataMap, prependData, appendData, rest) {
    ...
    var data = typeof dataMap === 'function' && (typeof storeData === 'undefined' ? 'undefined' : _typeof(storeData)) === 'object' && storeData instanceof Array ? storeData.map(dataMap) : storeData;

    console.log('before', storeData, data, prependData, appendData);
