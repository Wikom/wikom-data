 ...
 * @return {Promise}
 */
var executeDelete = function executeDelete(_ref19) {
    var url = _ref19.url;
    return function () {
        var req = del({ url: url });
        var promise = req;
 ...
 * @return {Promise}
 */
var directDelete = exports.directDelete = function directDelete(_ref20) {
    var url = _ref20.url,
        _ref20$refresh = _ref20.refresh,
        refresh = _ref20$refresh === undefined ? null : _ref20$refresh;
    return function (dispatch) {
 ...
 * @return {Promise}
 */
var confirmAndDelete = exports.confirmAndDelete = function confirmAndDelete(_ref21) {
    var url = _ref21.url,
        _ref21$refresh = _ref21.refresh,
        refresh = _ref21$refresh === undefined ? null : _ref21$refresh,
        _ref21$message = _ref21.message,
        message = _ref21$message === undefined ? 'Sind Sie sicher, dass Sie diesen Eintrag löschen möchten?' : _ref21$message;
    return function (dispatch) {
