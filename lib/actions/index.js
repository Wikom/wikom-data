...
var directDelete = exports.directDelete = function directDelete(_ref20) {
    var url = _ref20.url,
        refresh = _ref20.refresh;
    return function (dispatch) {
        return dispatch(executeDelete({ url: url })).then(function (result) {
            return refresh ? dispatch(refreshData({ name: refresh })) : Promise.resolve('success');
        }).catch(function (error) {
...
var confirmAndDelete = exports.confirmAndDelete = function confirmAndDelete(_ref21) {
    ...
    return function () {
        return confirm(message) ? directDelete({ url: url, refresh: refresh }) : Promise.resolve('canceled');
    };
};